package op.legends.freakfly.modules;
...
import op.legends.freakfly.Addon;

public class FreakFly extends Module {
    ...
    public FreakFly() {
        super(Addon.CATEGORY, "elytra-freakfly", "freaky fly");
    }
